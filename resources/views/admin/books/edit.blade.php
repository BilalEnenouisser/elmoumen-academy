...
@section('content')
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">✏️ Modifier le Livre</h1>
        <p class="text-gray-600">Modifier les informations du livre</p>
    </div>
        ...
        <div class="bg-white rounded-lg shadow p-4 md:p-6">
            ...
            <div class="mt-4">
                ...
                <textarea name="description" 
                          ...
                          rows="4"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                          placeholder="Description détaillée du livre...">{{ old('description', $book->description) }}</textarea>
                @error('description')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           step="0.01"
                           min="0"
                           value="{{ old('reduced_price', $book->reduced_price) }}"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                        Nouvelle Image <span class="text-gray-500">(optionnel)</span>
                    </label>
                    <input type="file" 
                           name="image" 
                           id="image" 
                ...
                <div id="image-preview" class="hidden">
                    <h4 class="text-sm font-medium text-gray-700 mb-2">Aperçu de la Nouvelle Image:</h4>
                    <div class="w-32 h-40 border border-gray-300 rounded-lg overflow-hidden">
