        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @for ($i = 1; $i <= 6; $i++)
                <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden">
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-gray-900 mb-3">Année {{ $i }}</h3>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center">
                ...
                <p class="text-gray-600">Cours, exercices et évaluations pour toutes les matières fondamentales</p>
            </div>
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600">Vidéos, animations et exercices pratiques pour un apprentissage engageant</p>
            </div>
