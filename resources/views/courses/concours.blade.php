        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            @foreach (['Médecine', 'Informatique', 'Génie Civil', 'Commerce'] as $category)
                <div class="glass-card glass-card-hover rounded-2xl overflow-hidden">
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-white mb-3">{{ $category }}</h3>
...
<section class="course-background py-20">
    <div class="course-content max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center glass-card p-6 rounded-2xl">
...
<section class="course-background py-20">
    <div class="course-content max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center glass-card p-6 rounded-2xl">
                <div class="text-4xl md:text-5xl font-bold text-red-300 mb-2">95%</div>
                <div class="text-lg text-blue-100">Taux de réussite</div>
            </div>
            <div class="text-center glass-card p-6 rounded-2xl">
                <div class="text-4xl md:text-5xl font-bold text-blue-300 mb-2">500+</div>
                <div class="text-lg text-blue-100">Étudiants admis</div>
            </div>
            <div class="text-center glass-card p-6 rounded-2xl">
                <div class="text-4xl md:text-5xl font-bold text-green-300 mb-2">50+</div>
                <div class="text-lg text-blue-100">Années d'expérience</div>
            </div>
        </div>
    </div>
</section>
