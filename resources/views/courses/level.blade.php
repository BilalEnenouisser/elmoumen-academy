        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach ($years as $year)
                <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden">
                        ...
                        <div class="h-48 bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center">
                            <div class="text-center text-white">
                                <div class="text-6xl font-bold mb-2">
                                    @php
                                        $yearNumber = preg_replace('/[^0-9]/', '', $year->name);
                                        echo $yearNumber ?: '?';
                                    @endphp
                                </div>
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-gray-900 mb-3">{{ $year->name }}</h3>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Programme Complet</h3>
                <p class="text-gray-600">Toutes les matières essentielles pour chaque année</p>
            </div>
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600">Vidéos, exercices et évaluations pour un apprentissage engageant</p>
            </div>
            ...
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Suivi Personnalisé</h3>
                <p class="text-gray-600">Accompagnement individualisé pour chaque élève</p>
            </div>
        </div>
    </div>
</section>
